...
We are committed to enhancing pets' happiness and health, extending their lives.
                </h1>
        ...
        <div className="container">
          <div className="lg:w-[470px] mx-auto">
            ...
            <p className="text__para text-center">
              World-Class Care for Every Paw. Our pet health system delivers
              unparalleled expertise in pet healthcare.
            </p>
          </div>
        ...
        <div className="container">
          <div className="flex items-center justify between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              ...
              <Link to="/">
                <button className="btn">Learn Home</button>
              </Link>
            </div>
