...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5 doc_card_box">
      <div>
        <img
          src={photo}
          className="w-full h-30 object-cover object-center doc_card_img "
          alt="" 
        />
      </div>
      ...
      <div className="mt-[18px] lg:mt-5 flex items-cente justify-betweenr">
        <div>
